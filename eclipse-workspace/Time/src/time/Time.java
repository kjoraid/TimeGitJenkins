...
public class Time
{
	public static void main(String[] args) 
	{
		...
		//int totalSeconds = getTotalMinutes(time);
		//int totalSeconds = getTotalHours(time);
	...
	public static int getTotalSeconds(String time)throws NumberFormatException, StringIndexOutOfBoundsException {
		...
		int milliSecond = getMilliSeconds(time);
	...
	{
		System.out.println("I have performed Before the test");
